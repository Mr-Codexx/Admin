...
function AdminDashboard() {
  // State for name color and night mode
  ...
  const changeNameColor = (color) => {
    setNameColor(color);
  };

  // Function to validate new user signups
  const validateUser = (user) => {
    // Logic to validate user, for example, check if the user is an admin
    if (user.role === 'admin') {
      setUsers([...users, user]); // Add user to the list of validated users
  ...
  return (
    <div className="app-container">
      ...
      {/* <div>
        ...
        <button onClick={() => validateUser({ name: 'NewUser', role: 'admin' })}>Validate New User</button>
      </div> */}
    </div>
  );
}
